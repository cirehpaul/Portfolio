const content = {
  hero: {
    ...
    resume: '/Portfolio/resume/Cire Paul Cruz (Resume).pdf',
  ...
  projects: {
    capstone: {
      ...
      images: ['/Portfolio/img/F.jpg', '/Portfolio/img/L.jpg', '/Portfolio/img/d.jpg', '/Portfolio/img/w1.jpg', '/Portfolio/img/w2.jpg', '/Portfolio/img/m1.jpg', '/Portfolio/img/m2.jpg', '/Portfolio/img/O.jpg']
    },
    other: [
      {
